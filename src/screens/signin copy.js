...
const cardImage = require('../assets/images/gradient.png');
const cardImage2 = require('../assets/images/gradient.png');
...
export default class CardsScreen extends Component {
  ...
  renderTextSection = () => {
    return (
      <Card.Section
        content={[
          {text: 'Youre Invited!', text70: true, grey10: true},
          {
  ...
  renderHorizontalCard = (isImageOnLeft, borderRadius, useSection) => {
    return (
      <Card
        row
        height={160}
