  ...
  .then(()=>{
    ...
    return (
        ...
        <View style={{flex:1,backgroundColor:'#FFB6C1'}}>
            ...
            <Text style={{marginTop:10,paddingLeft:10,fontSize:20,color:'white'}}>M.Zulkifal khan</Text>
            </View>
      ...
      <TouchableOpacity style={styles.loginBtn}>
         <Text style={{fontSize:15,color:'white'}}>Switch to Travel Guide</Text>
               ...
               <Feather name="log-out"  size={24} color="black" style={{marginTop:10,paddingLeft:10}} />
               <Text style={styles.loginBtn}style={{color:'white',fontSize:20,marginTop:10,paddingLeft:20,flexDirection:'row'}}>Sign Out</Text>
               </View>
             </TouchableOpacity>
               </View>
               </View>
